...
const seedData = async () => {
  ...
  try {
    ...
    const sampleArticles = [
      {
        ...
        snippet: 'The government has unveiled ambitious new targets for carbon emissions reduction, aiming to achieve net zero by 2050. The policy includes significant investments in renewable energy and green technology.',
        language: 'en',
      ...
      },
      {
        ...
        snippet: 'Manchester United have completed the signing of a world-class midfielder in a deal worth £80 million. The player is expected to make his debut this weekend.',
        language: 'en',
      ...
      },
      {
        ...
        canonical_url: 'https://www.reuters.com/world/europe/breaking-news-12345680',
        title: 'European Markets Show Strong Growth',
        snippet: 'Stock markets across Europe posted significant gains today, with the FTSE 100 up 2.3% and the DAX climbing 1.8%. Analysts cite positive economic indicators and strong corporate earnings.',
        language: 'en',
      ...
      },
      {
        ...
        canonical_url: 'https://www.theguardian.com/uk-news/2024/jan/15/london-transport-12345681',
        title: 'London Transport Strike Causes Major Disruption',
        snippet: 'Thousands of commuters faced travel chaos as transport workers staged a 24-hour strike over pay and working conditions. Alternative arrangements have been put in place.',
        language: 'en',
      ...
      },
      {
        ...
        snippet: 'Researchers have developed a new artificial intelligence system that can process natural language with unprecedented accuracy. The technology could revolutionize customer service and education.',
        language: 'en',
    ...
    // 4. Add AI enhancements for some articles
    console.log('🤖 Adding AI enhancements...');
    const aiEnhancements = [
      {
        article_id: articles[0].id,
        ai_title: 'UK Unveils Ambitious Net Zero Climate Strategy with £50bn Investment',
        ai_summary: 'The UK government has announced a comprehensive climate policy featuring aggressive carbon reduction targets and substantial green technology investments.',
        ai_details: '• Net zero emissions target by 2050\n• £50 billion investment in renewable energy\n• New green jobs initiative\n• Carbon tax reforms',
        ai_language: 'en',
        model: 'gemini-1.5-flash',
        prompt_hash: 'climate_policy_001',
        is_current: true
      },
      {
        article_id: articles[1].id,
        ai_title: 'Manchester United Complete Record-Breaking £80m Midfielder Signing',
        ai_summary: 'Manchester United have secured a world-class midfielder in their biggest transfer of the season, strengthening their squad for the title race.',
        ai_details: '• Transfer fee: £80 million\n• 5-year contract signed\n• Expected debut this weekend\n• Strengthens midfield options',
        ai_language: 'en',
        model: 'gemini-1.5-flash',
        prompt_hash: 'transfer_news_001',
        is_current: true
      }
    ];
    ...
    const { data: aiData, error: aiError } = await supabase
      .from('article_ai')
      .upsert(aiEnhancements)
      .select();

    if (aiError) throw aiError;
    console.log(`✅ Added ${aiData.length} AI enhancements`);
    ...
    console.log(`   • ${aiData.length} AI enhancements`);
